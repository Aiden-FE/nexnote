...
export const AGENT_SCENARIOS = ['chat', 'writing', 'debug', 'translation'] as const;
export const AGENT_CHANNELS = [
  'agent:run:chat',
  'agent:run:writing',
  'agent:run:debug',
  'agent:run:translation',
  'agent:cancel',
...
export interface AgentChannelMap {
  ...
  'agent:run:translation': { request: AgentRunRequest; response: Result<{ runId: string }> };
