...
const contributions: PluginContributionView[] = [
  { id: 'hello', scopedId: 'com.demo:hello', pluginId: 'com.demo', kind: 'commands', title: 'Hello' },
  { id: 'tools', scopedId: 'com.demo:tools', pluginId: 'com.demo', kind: 'menus', title: 'Tools' },
  { id: 'panel', scopedId: 'com.demo:panel', pluginId: 'com.demo', kind: 'views', title: 'Panel', placement: 'sidebar' },
  { id: 'card', scopedId: 'com.demo:card', pluginId: 'com.demo', kind: 'blockTypes', title: 'Card', blockType: 'card' },
  { id: 'mainview', scopedId: 'com.demo:mainview', pluginId: 'com.demo', kind: 'views', title: 'Main', placement: 'main' },
];
...
describe('插件扩展点宿主派生（DEV-014）', () => {
  it('菜单项进入「插件」右键子菜单并带 scopedId 动作', () => {
    ...
    expect(items[0]!.submenu?.[0]).toMatchObject({ id: `${PLUGIN_MENU_ACTION_PREFIX}com.demo:tools`, title: 'Tools' });
